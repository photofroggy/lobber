...
var Protocol = require('lobber').protocol;
...
LobbyManager.prototype.createLobby = function( name, connection, plob ) {

    if( !this.lobbys.hasOwnProperty( name ) )
        return false;
    
    var lobby = new this.lobbys[name].manager( connection, plob );
